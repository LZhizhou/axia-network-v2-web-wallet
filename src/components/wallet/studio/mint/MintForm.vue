...
import { NFTMintOutput, NFTTransferOutput, UTXO } from '@axia-systems/axiajs/dist/apis/avm'
...
import { PayloadBase, URLPayload, UTF8Payload, JSONPayload } from '@axia-systems/axiajs/dist/utils'
